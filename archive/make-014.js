...
{
 check(is_str,x)
 const _=pass_parse(x)
 {
  const nodes=_
  {
   const _=pass_fold(nodes)
   {
    const nodes=_
    {
     const _=pass_scope(nodes)
     {
      const nodes=_
      {
               ...
               let name=_
               {
                const _=null
                {
                 let rvalue=_
                 {
                  ...
                  {
                   const _=pass_scope(node.children)
                   {
                    const children=_
                    {
                     const _={operator,parameters,children}
