         ...
         const _=split(source)
         {
          const lines=_
          {
           const _=7
           {
            const range=_
            {
             for(let i=0;i<((typeof(range)==="function")?range():range);i++)
             {
              const _=div(range,2)
              {
               const n=_
       ...
       const _=true
       {
        const colors=_
        {
         const _=null
         {
          ...
          {
           const _={showHidden,depth,colors,maxArrayLength}
           {
            const o=_
            {
...
function main()
{
 ...
 {
  global.html=(typeof(dom_html)==="function")?dom_html():dom_html
  global.body=(typeof(document.body)==="function")?document.body():document.body
  global.font="1.5vw monospace"
  function on_error(x,y,z,a,b)
  {
   check(is_str,x)
   check(is_str,y)
   check(is_uint,z)
