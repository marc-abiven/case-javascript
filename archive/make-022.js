    ...
    const _=x.parameters
    {
     const parameters=_
     {
      const _=x.children
      {
       const children=_
       {
        const _=space(x.operator,...parameters)
        {
         const s=_
         {
          push(a,s)
...
function flower(x)
{
 const _=process.stdout.columns
 {
  const n=_
  {
   if(is_undef(x))
     ...
     const _={maxBuffer,encoding}
     {
      const o=_
      {
       const _=cp.spawnSync(x,y,o)
       {
        const streams=_
        {
         const _=streams.stdout.toString()
         {
          const out=_
          {
           const _=trim_r(out)
           {
            const out=_
            {
             const _=streams.stderr.toString()
             {
              const err=_
              {
               const _=trim_r(err)
