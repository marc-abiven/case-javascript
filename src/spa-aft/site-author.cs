fn site_author site:obj id:uint
 let entity entity_init site site.authors id "?a="
 ...
 breadcrumb_push breadcrumb "Auteurs" "?v=auth"
 ...
 for site.posts
  if same v.author entity.item.name
   cont
