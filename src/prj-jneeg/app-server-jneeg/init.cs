gn init x:etc
 ...
 if not random
  ...
  sudo_fs_change_owner "/dev/gpiochip0" "root.gpio"
  sudo_fs_change_owner "/dev/gpiochip1" "root.gpio"
  sudo_fs_change_mode "/dev/gpiochip0" "660"
  sudo_fs_change_mode "/dev/gpiochip1" "660"
 end
