fn site_authors site:obj

 assign document.title "Auteurs"
 ...
 breadcrumb_push breadcrumb "Auteurs"
 ...
 let tbl copy site.authors

 tbl_index tbl
 tbl_remove_column tbl "index"

 tbl_rename_column tbl "name" "Nom"
