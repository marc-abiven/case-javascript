fn cpl_scope x y
 ...
 while is_full a
  ...
  if is_declare operator
   ...
   let children arr
   let node2 obj operator parameters children
   ...
   let parameters arr
   let children arr   
   let node3 obj operator parameters children
   ...
   let children arr     
   let node4 obj operator parameters children
   ...
   let node5 obj operator parameters children
   ...
   let node obj operator parameters children
