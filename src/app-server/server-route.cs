gn server_route server query
 check is_obj server
 check is_obj query

 fn match_host ons host path components
  check is_obj ons
  check is_str host
  check is_str path
  check is_arr components
 ...
 fn match_any ons host path components
  check is_obj ons
  check is_str host
  check is_str path
  check is_arr components
 ...
 fn match_host_path ons host path components
  check is_obj ons
  check is_str host
  check is_str path
  check is_arr components
 ...
 fn match_host_any ons host path components
  check is_obj ons
  check is_str host
  check is_str path
  check is_arr components
 ...
 fn match_any_path ons host path components
  check is_obj ons
  check is_str host
  check is_str path
  check is_arr components
 ...
 fn match_any_any ons host path components
  check is_obj ons
  check is_str host
  check is_str path
  check is_arr components
 ...
 forof matches
  ...
  try
   if is_fn on
    assign result on server host url method remote request response
   elseif is_gn on
    assign result run on server host url method remote request response
   else
    stop
  catch e
   assign error e
